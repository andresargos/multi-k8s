...
kubectl set image deployments/client-deployment client=gorillavila/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=gorillavila/multi-worker:$SHA